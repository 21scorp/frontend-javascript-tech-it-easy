...
const P: Record<IconName, string> = {
  ...
  /* ── currency & rewards ─────────────────────────────────────── */
  coin:
    `<path fill-rule="evenodd" d="M12 2.4a9.6 9.6 0 1 0 0 19.2 9.6 9.6 0 0 0 0-19.2zm0 3a6.6 6.6 0 1 1 0 13.2 6.6 6.6 0 0 1 0-13.2z"/>
     <path d="M12.9 7.1v1.4c1 .2 1.8.6 2.5 1.2l-1.3 1.6c-.6-.5-1.3-.8-2.2-.8-.7 0-1.1.2-1.1.6 0 .5.4.7 1.7 1 1.9.4 3.1 1.1 3.1 2.8 0 1.4-1 2.4-2.6 2.6v1.4h-2v-1.4c-1.2-.2-2.2-.7-3-1.4l1.4-1.6c.7.6 1.5 1 2.5 1 .8 0 1.3-.2 1.3-.7 0-.4-.4-.6-1.8-.9-1.9-.4-3.1-1.1-3.1-2.7 0-1.3 1-2.3 2.7-2.6V7.1z"/>`,
  gem:
