...
const P: Record<IconName, string> = {
  ...
  axe:
    `<rect x="10.6" y="4" width="2.9" height="17.4" rx="1.45" transform="rotate(45 12 12)"/>
     <g transform="rotate(45 12 12)">
       <path d="M12 3.1a7.7 7.7 0 0 1 0 15.4v-3.7a4 4 0 0 0 0-8z"/>
       <path d="M12 4.9a5.9 5.9 0 0 1 0 11.8v-1.5a4.4 4.4 0 0 0 0-8.8z" class="ic-hi"/>
     </g>`,
  pickaxe:
    `<rect x="10.7" y="6.2" width="2.6" height="15.2" rx="1.3"/>
     <path d="M2.4 9.4C5.3 6.6 8.7 5.1 12 5.1s6.7 1.5 9.6 4.3l-1.7 2.7c-2.5-2.3-5.2-3.4-7.9-3.4s-5.4 1.1-7.9 3.4z"/>
     <path d="M4.4 9.2C6.8 7.3 9.4 6.4 12 6.4s5.2.9 7.6 2.8l-.7 1.1C16.7 8.7 14.4 8 12 8s-4.7.7-6.9 2.3z" class="ic-hi"/>`,
  sword:
  ...
  flame:
    `<path d="M12 1.8c1.4 3.4 5.6 5 5.6 9.4a5.6 5.6 0 1 1-11.2 0c0-2.9 2.4-3.8 5.6-9.4z"/>
     <path d="M12 10.4c.8 1.9 2.7 2.5 2.7 4.6a2.7 2.7 0 1 1-5.4 0c0-1.6 1.7-2.1 2.7-4.6z" class="ic-hi"/>`,
  anvil:
    `<path d="M2.6 6.2h12.9c.5 2.2 2.4 3.6 5 3.8v2.4c-3.3-.1-6.1-1.5-7.6-3.5H4.9c-1.4 0-2.3-1.1-2.3-2.7z"/>
     <path d="M9.4 8.9h5.2l-.9 7.4h-3.4z"/>
     <rect x="5.6" y="16.2" width="12.8" height="3.6" rx="1.5"/>
     <path d="M3.6 6.9h11v1.1h-11z" class="ic-hi"/>`,
  sprout:
  ...
  bow:
    `<g transform="rotate(-45 12 12)">
       <path d="M12 2.4a9.6 9.6 0 0 1 0 19.2v-2.9a6.7 6.7 0 0 0 0-13.4z"/>
       <rect x="11.1" y="2.4" width="1.5" height="19.2" rx=".75" class="ic-hi"/>
       <rect x="4" y="11.1" width="15" height="1.8" rx=".9"/>
       <path d="M2.2 12 6.4 9.4v5.2z"/>
     </g>`,
  gear:
    `<g>
